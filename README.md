...
> [!IMPORTANT]
> **خطوة هامة بعد النشر:** لكي تعمل لوحة التحكم، يجب عليك تفعيل الدخول عبر GitHub:
> 1. اذهب إلى إعدادات المطورين في GitHub وأنشئ **OAuth App** جديد.
> 2. في Netlify، اذهب إلى **Site Settings > Access control > OAuth** وأضف GitHub.
...
> [!TIP]
> **إدارة المحتوى محلياً:** لتحرير المقالات والصفحات، افتح `/keystatic` في المتصفح أثناء تشغيل `npm run dev`.
> 
> Keystatic يوفر واجهة رسومية سهلة لإدارة المحتوى مباشرة من الملفات المحلية - لا حاجة لإعداد OAuth أو خوادم خارجية!
...
### 📝 إدارة المحتوى
- ✅ **Keystatic CMS** - نظام إدارة محتوى محلي (Local-First)
- ✅ إضافة/تعديل/حذف المقالات من واجهة رسومية
- ✅ رفع الصور مباشرة
- ✅ معاينة المقالات أثناء الكتابة
- ✅ لا حاجة لـ OAuth أو إعدادات خارجية
...
- **[Keystatic](https://keystatic.com/)** - نظام إدارة المحتوى المحلي
...
### إضافة مقال عبر Keystatic

1. شغل السيرفر المحلي: `npm run dev`
2. افتح المتصفح على `http://localhost:4321/keystatic`
3. اختر "المقالات" من القائمة الجانبية
4. اضغط "Create Blog"
5. املأ البيانات واكتب المحتوى
6. اضغط "Save" - سيتم حفظ الملف تلقائياً في `src/content/blog/`
...
- [Keystatic](https://keystatic.com/) - نظام إدارة المحتوى البسيط والقوي
