...
> [!IMPORTANT]
> **ملاحظة للمطورين:** لتجربة لوحة التحكم محلياً، استخدم الأوامر التالية:
> 
> ```bash
> # تفعيل الوضع المحلي (Local Development)
> npm run cms:local
> 
> # العودة للوضع الإنتاجي (Production) قبل النشر
> npm run cms:production
> ```
> 
> هذه الأوامر تقوم تلقائياً بتعديل إعدادات `local_backend` في ملف `public/admin/config.yml`.
