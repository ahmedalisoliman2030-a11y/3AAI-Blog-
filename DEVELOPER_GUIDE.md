...
هذا الدليل موجه للمطورين الذين يرغبون في فهم البنية التقنية للمشروع، أو المساهمة فيه، أو فهم تفاصيل الانتقال من Decap CMS إلى Keystatic.

---

## 🏗️ البنية التقنية

المشروع مبني باستخدام **Astro** كإطار عمل أساسي، مع **React** للمكونات التفاعلية، و **Keystatic** لإدارة المحتوى.
...
│   │   ├── authors/       # ملفات المؤلفين (.yaml/.mdoc)
...
نستخدم `getCollection` من `astro:content` لجلب البيانات، تماماً كما في Astro العادي، لكن مع دعم قوي لـ Markdoc.
...
- **Unit Tests:** يمكن إضافة اختبارات للمكونات باستخدام Vitest.
- **E2E Tests:** يمكن استخدام Playwright لاختبار تدفق إنشاء المحتوى في Keystatic (اختياري).
